...
$( document ).ready( function() {
      ...
      var entries = [ 
          ...
          { label: 'Bootstrap', url: 'http://www.getbootstrap.com', target: '_blank' },
          { label: 'MaterializeCSS', url: 'http://www.materializecss.com', target: '_blank' },
          ...
          { label: 'Python URL shortener', url: 'https://github.com/NaiRobley/PyShorte.st', target: '_blank' },
          { label: 'Eureka', url: 'https://github.com/NaiRobley/eureka', target: '_blank' },
          { label: 'Bounce!', url: 'https://github.com/NaiRobley/bouncegame', target: '_blank' },
          ...
          { label: 'GitHub', url: 'https://github.com/NaiRobley', target: '_blank' },
